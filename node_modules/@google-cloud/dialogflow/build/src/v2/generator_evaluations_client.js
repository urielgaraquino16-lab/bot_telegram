...
class GeneratorEvaluationsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createGeneratorEvaluationResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.GeneratorEvaluation');
        const createGeneratorEvaluationMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.GeneratorEvaluationOperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.v2.GeneratorEvaluations', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.generatorEvaluationsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.dialogflow.v2.GeneratorEvaluations') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.dialogflow.v2.GeneratorEvaluations, this._opts, this._providedCustomServicePath);
